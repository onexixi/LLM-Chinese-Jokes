...
from langchain_core.utils.json import parse_partial_json, _parse_json, _custom_parser
...
class AnalysisPlanModule:
    ...
    def initial_analysis_plan(self):
        return [
            {
                "name": "步骤 1: 问题定义和系统思维",
                "methods": ["系统思维", "分析性思维", "批判性思维"],
                "data_collection": []
            },
            {
                "name": "步骤 2: 数据收集和分析",
                "methods": ["实证主义方法", "分析性思维", "网络思维"],
                "data_collection": []
            },
            {
                "name": "步骤 3: 根本原因分析",
                "methods": ["逻辑思维", "归纳思维", "演绎思维"],
                "data_collection": []
            },
            {
                "name": "步骤 4: 创新解决方案生成",
                "methods": ["创造性思维", "发散思维", "横向思维"],
                "data_collection": []
            },
            {
                "name": "步骤 5: 方案评估和决策",
                "methods": ["收敛思维", "多标准决策分析思维", "博弈论思维"],
                "data_collection": []
            },
            {
                "name": "步骤 6: 实施规划",
                "methods": ["系统思维", "长期思维", "敏捷思维"],
                "data_collection": []
            },
            {
                "name": "步骤 7: 未来影响评估",
                "methods": ["场景思维", "情景规划思维", "反事实思维"],
                "data_collection": []
            },
            {
                "name": "步骤 8: 反思和优化",
                "methods": ["元认知", "开放性思维", "批判性思维"],
                "data_collection": []
            }
        ]
...
"""
        ...
        try:
            optimization_data = _custom_parser(optimization_response)
...
class ImprovedAnalyzer:
    ...
    def analyze_problem(self, problem):
        ...
        for step_index in range(len(self.analysis_plan.current_plan)):
            result = self.step_executor.execute_step(problem, step_index)
            results.append(result)
            self.step_executor.optimize_plan(problem, self.analysis_plan.current_plan[step_index], result)
