...
class QASystem:
    ...
    def generate_question(self, topic, question_id):
        ...
        # 随机选择1-2个已有方案（如果有的话）
        selected_methods = random.sample(existing_methods, min(2, len(existing_methods)))
        ...
        prompts = [
            ...
            f"""关于主题'{topic}'，{methods_prompt}请提出一个聚焦于改善低教育水平群体生活质量的问题。这个问题应该：
            1. 探讨如何通过商业创新提高这些群体的就业能力
            2. 考虑结合教育和商业模式的可能性
            3. 思考如何设计直观、易用的产品或服务以满足这一群体的需求
            4. 探索利用新技术弥补教育差距的商业机会
            请直接给出问题，无需其他解释。""",

            f"""想象一个面临人口老龄化和独居老人增多的社会。基于主题'{topic}'，{methods_prompt}提出一个问题，探讨：
            1. 如何开发适合老年人的创新产品或服务
            2. 应对失去亲人后的孤独感可能带来的商业机会
            3. 如何平衡盈利和提供情感支持的社会责任
            4. 科技如何在尊重隐私的前提下改善老年人的生活质量
            请直接给出问题，无需其他解释。""",

            f"""考虑到全球范围内的衣食住行基本需求，关于主题'{topic}'，{methods_prompt}提出一个问题，探讨：
            1. 如何通过商业创新解决发展中国家的基础设施问题
            2. 在保证可及性和可负担性的同时，如何提高基本生活用品的质量
            3. 共享经济模式如何应用于改善低收入群体的生活条件
            4. 如何将环境可持续性融入面向基本需求的商业模式
            请直接给出问题，无需其他解释。""",

            f"""基于主题'{topic}'，{methods_prompt}提出一个关于为弱势群体（如残障人士、少数族裔）创造就业机会的问题。这个问题应该：
            1. 探讨如何设计包容性的工作环境和商业模式
            2. 考虑利用这些群体的独特优势创造商业价值的可能性
            3. 思考如何通过商业创新促进社会包容和多元化
            4. 探索技术如何帮助克服这些群体在就业中面临的障碍
            请直接给出问题，无需其他解释。""",
